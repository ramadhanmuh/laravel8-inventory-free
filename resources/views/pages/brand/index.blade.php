                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>
                                Nama
                                <a href="{{ route('brands.index', ['order_by' => 'name', 'order_direction' => 'desc', 'keyword' => $input['keyword']]) }}"
                                ...
                                <a href="{{ route('brands.index', ['order_by' => 'name', 'order_direction' => 'asc', 'keyword' => $input['keyword']]) }}"
                                    class="btn btn-sm p-0 px-1 float-right">
                        ...
                        @else
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{ route('brands.edit', $item->id) }}" class="btn btn-warning btn-sm">
                                            Ubah
                                        </a>
